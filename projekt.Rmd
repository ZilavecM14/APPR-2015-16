...
>>>>>>> f971d3da5ab8e0a04abc5ac042e285d005f6b140
...
Podatke sem prečistilna na naslednji način. 
...
```{r razredelnice, echo=FALSE}
kable(head(skupaj14))

```


Drugo tabelo sem uvozila v obliki csv s spletne strani (http://pxweb.stat.si/pxweb/Dialog/Saveshow.asp). Razpredelnico sem naložila s podatki o številu štipendij v različnih regijah v Soveniji, ločene na spol in leta. 

```{r razpredelnice1, echo=FALSE}
kable(head(stipendije))
