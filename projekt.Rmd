...
```{r graf6, echo=FALSE, FIG.CAP="Število podeljenih štipendij za leti 2008-2014 za dijake"}
graf6
```

```{r graf7, echo=FALSE, FIG.CAP ="Število podeljenih štipendij za leti 2008-2014 za študente"}
graf7
```
